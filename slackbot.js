...
app.command('/tt', ({ command, ack, say, client, respond, }) => __awaiter(void 0, void 0, void 0, function* () {
    // Acknowledge command request
    yield ack();
    console.log('2');
    try {
        const tasksSaved = yield saveTasks(command);
...
const updateUserHomeTab = (client, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const tasksGroupedByDate = yield new TasksQueryService().getTasksByEmployee(userId);
...
export const events = (event, context) => __awaiter(void 0, void 0, void 0, function* () {
    logMetadata();
    console.log('event.body:', event.body);
    const bolt = yield app.start();
    return bolt(event, context);
});
export const saveTasks = ({ text, user_id, user_name }) => __awaiter(void 0, void 0, void 0, function* () {
